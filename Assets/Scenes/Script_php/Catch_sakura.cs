...
public class Catch_sakura : MonoBehaviour {

    public Text ResultText_;    //結果を格納するテキスト
    public Text InputText_;     //idを入力するインプットフィールド

    // public string ServerAddress = "localhost:8888/unity/selecttest.php";
    // public string ServerAddress = "localhost:8888/unity/sakura/selecttest.php";
    public string ServerAddress = "https://stokyo.sakura.ne.jp/PHPtest/selecttest.php";
    ...
    private IEnumerator Access() {
        ...
        dic.Add("contributor", InputText_.GetComponent<Text>().text);  //インプットフィールドからidの取得);
